...
Assume that $X$ is a nonsingular scheme and that $Y \subset X$ is a nonsingular subscheme. Now $Y$ is locally cut out from $X$ by a regular sequence, and hence the blow-up of $X$ along $Y$ has a nice local description, as the next proposition shows.
